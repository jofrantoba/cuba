...
public interface SearchField<V> extends LookupField<V> {
    ...
    /**
     * Sets notifications configuration object that determine what messages will be shown in case of too small
    ...
    /**
     * Sets a type of notifications (TRAY, WARNING, etc) that will be shown in case of too small search string or
     * absence of matches.
     *
